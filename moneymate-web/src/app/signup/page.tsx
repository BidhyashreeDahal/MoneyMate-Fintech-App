      ...
      <div className="w-full max-w-md mx-auto bg-white border border-emerald-100 rounded-3xl shadow-2xl overflow-hidden">
        <div className="p-6 sm:p-8 bg-gradient-to-br from-emerald-600 to-emerald-500 text-white">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div className="text-sm text-emerald-50">Build healthy money habits</div>
            </div>
          </div>
          <div className="mt-4 grid grid-cols-2 gap-3 text-[11px]">
            <div className="rounded-lg bg-white/10 px-3 py-2">Budgets</div>
            <div className="rounded-lg bg-white/10 px-3 py-2">Goals</div>
          </div>
        </div>
        ...
        <div className="p-6 sm:p-8">
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-500">Get started in a minute</p>
          </div>
